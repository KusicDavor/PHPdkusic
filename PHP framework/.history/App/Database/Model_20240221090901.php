...
class Model {
    ...
    public static function find($primaryKey) {
        ...
        $stmt->bind_param('i', $primaryKey); // 'i' označava integer
        $stmt->execute();
        $result = $stmt->get_result()->fetch_object();
        $jsonResult = json_encode($result); // Pretvaranje stdClass u JSON format
        $assocArray = json_decode($jsonResult, true); // Pretvaranje JSON-a u asocijativno polje   
        return $assocArray;
