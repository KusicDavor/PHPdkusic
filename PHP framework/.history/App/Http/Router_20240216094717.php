  ...
  public function addRoute(Route $route) {
    ...
    public function handleRequest() : ResponseInterface {
      foreach ($this->routes as $route) {
          if ($route->url === $this->request->getParameter('url') && $route->method === $request->getParameter('method')) {
              ...
              return $response = new Response(300, "vratio");; // Exit loop after handling the request
          }
          $response = new Response(300, "vratio");
          // return 
