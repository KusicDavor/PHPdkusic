...
class Router {
  ...
  public static function handleRequest() : ResponseInterface {
    ...
    // Now $requestData contains the data sent through the PUT request
    // You can access the data using keys corresponding to form field names
    $ime = $requestData['ime'];
    $spol = $requestData['spol'];
    $dob = $requestData['dob'];
