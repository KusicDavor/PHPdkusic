...
class Router {
  ...
  private function srediRequest(Request $request) {
    Router::$ime = $request->getParameter('ime');
    Router::$spol = $request->getParameter('spol');
    Router::$dob = $request->getParameter('dob');
  }

  public function handleRequest(Request $request) {
    $this->srediRequest($request);
  ...
  public static function obradiRequest() : ResponseInterface {
    ...
    $content = "Ime: Router::$ime<br>Spol: $spol<br>Dob: $dob<br>Osoba uspješno obrađena.";
