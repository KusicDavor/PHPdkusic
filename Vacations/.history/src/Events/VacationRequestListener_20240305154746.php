...
class VacationRequestListener implements EventSubscriberInterface
{
    ...
    private $transport;
    private $bus;
    public function __construct(MessageBusInterface $bus, EntityManagerInterface $entityManager, TransportInterface $transport)
    {
    ...
    private function onVacationRequestApproved(VacationRequest $vacationRequest)
    {
        ...
        this->$bus->dispatch(new SmsNotification($vacationRequest));
        return;
    }
