...
class UserType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addEventListener(FormEvents::PRE_SUBMIT, function (FormEvent $event, User $user) {
            $user = $event->getData();
            $form = $event->getForm();

            $userRepository = $user->UserRepository::class;
            $nonAdminRoles = $userRepository->findNonAdminRoles();
