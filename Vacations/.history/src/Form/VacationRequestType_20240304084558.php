...
class VacationRequestType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->addEventListener(FormEvents::PRE_SUBMIT, function (FormEvent $event), ExecutionContextInterface $context use ($user) {
            ...
            if ($daysDiff > $user->getVacationDays()) {
                $context->buildViolation('You do not have enough available days.')
                    ->addViolation();
            }
        });
    }
