...
class VacationRequestController extends AbstractController
{
    ...
    #[Route('/decide/{id}', name: 'app_vacation_decide', methods: ['POST'])]
    public function subtract(Request $request, VacationRequest $vacationRequest, EntityManagerInterface $entityManager, EventDispatcherInterface $dispatcher): Response
    {
