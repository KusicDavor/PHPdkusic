...
class UserController extends AbstractController
{
    ...
    public function edit(Request $request, User $user, EntityManagerInterface $entityManager, UserPasswordHasherInterface $passwordEncoder): Response
    {
        ...
        $form->handleRequest($request);
        $user = $form->getData();
        $this->checkOnTeamChange($this->getUser(), $user, $entityManager);
    ...
    private function checkOnTeamChange(User $updatedUser, User $newUser, EntityManagerInterface $entityManager): void
    {
