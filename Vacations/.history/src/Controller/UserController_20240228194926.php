...
class UserController extends AbstractController
{
    ...
    private function checkOnTeamChange(User $newUser, EntityManagerInterface $entityManager): void
    {
        $user = $this->getUser();
        $oldUser = $user->getUserIdentifier();
        var_dump($oldUser->getUsername() === $newUser->getUsername());
