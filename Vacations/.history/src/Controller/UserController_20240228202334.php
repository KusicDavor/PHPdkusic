...
class UserController extends AbstractController
{
    ...
    {
        $oldTeamLeader = $oldTeam->getTeamLeader()->getId() ?? null;
        $oldTeamLeader = $oldTeam->getTeamLeader();
        $oldProjectLeader = $oldTeam->getProjectLeader();

        error_log($oldTeamLeader->getName() . "------------------------");
        error_log($oldProjectLeader->getName() . "------------------------");
    }
