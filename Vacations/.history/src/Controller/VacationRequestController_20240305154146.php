...
class VacationRequestController extends AbstractController
{
    ...
    public function approve(MessageBusInterface $bus, Request $request, VacationRequest $vacationRequest, EntityManagerInterface $entityManager, EventDispatcherInterface $dispatcher): Response
    {
        ...
        $bus->dispatch(new SmsNotification(VacationRequest::class, $vacationRequest));
        return $this->redirectToRoute('app_vacation_request_index', [], Response::HTTP_SEE_OTHER);
    }
}
