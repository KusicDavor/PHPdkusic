...
class UserController extends AbstractController
{
    ...
    public function delete(Request $request, User $oldUser, EntityManagerInterface $entityManager): Response
    {
    ...
    private function checkOnTeamChange(Form $form, User $oldUser, EntityManagerInterface $entityManager): void
    {
        $oldemail = $oldUser->getEmail();
        $email = $form->get('email')->getData();
        error_log($email . "------------------------" . $oldemail);
