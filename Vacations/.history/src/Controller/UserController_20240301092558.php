...
class UserController extends AbstractController
{
    ...
    private function checkOnTeamChange(?Team $oldTeam, User $newUser, EntityManagerInterface $entityManager, RoleRepository $roleRepository): void
    {
        $roles = $roleRepository;
        $newTeam = $newUser->getTeam();
