...
class UserController extends AbstractController
{
    ...
    {
        $oldUser = $entityManager->getRepository(User::class)->find($user->getId());
        $this->checkOnTeamChange($oldUser, $entityManager);
    ...
    private function checkOnTeamChange(User $oldUser, EntityManagerInterface $entityManager): void
    {
