...
class VacationRequestController extends AbstractController
{
    ...
    public function approve(Request $request, VacationRequest $vacationRequest, EntityManagerInterface $entityManager, EventDispatcherInterface $dispatcher)
    {
        ...
        if ($vacationRequest->isTeamLeadAction() || $vacationRequest->isProjectLeadAction()) {
            ...
            polje[] = implode($dispatcher->getListeners('vacation_request.approved'));
            error_log($dispatcher->getListeners('vacation_request.approved'));
        }
