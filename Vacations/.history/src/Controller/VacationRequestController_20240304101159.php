...
class VacationRequestController extends AbstractController
{
    ...
    public function approve(Request $request, EntityManagerInterface $entityManager)
    {
        return $this->redirectToRoute('app_vacation_request_index', [], Response::HTTP_SEE_OTHER);
    }

    #[Route('/decline', name: 'app_vacation_request_new', methods: ['GET', 'POST'])]
    public function decline(Request $request, EntityManagerInterface $entityManager)
    {
        return $this->redirectToRoute('app_vacation_request_index', [], Response::HTTP_SEE_OTHER);
    }
}
