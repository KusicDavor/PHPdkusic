...
final class Version20240228132801 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE team ADD CONSTRAINT FK_C4E0A61FC4105033 FOREIGN KEY (team_leader_id) REFERENCES user (id) ON UPDATE CASCADE');
        $this->addSql('ALTER TABLE team ADD CONSTRAINT FK_C4E0A61F62290B03 FOREIGN KEY (project_leader_id) REFERENCES user (id) ON UPDATE CASCADE');
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649D60322AC FOREIGN KEY (role_id) REFERENCES role (id) ON UPDATE CASCADE ');
