...
class ApiKeyAuthenticator extends AbstractAuthenticator
{
    ...
    public function __construct(EntityManagerInterface $entityManager, JwtTokenManager $jwtToken)
    {
    ...
    public function authenticate(Request $request, TokenStorageInterface  $tokenStorage): Passport
    {
