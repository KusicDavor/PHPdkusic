...
class AuthController extends AbstractController
{
    ...
    public function __construct(EntityManagerInterface $entityManger, UserPasswordHasherInterface $passwordEncoder, JWTTokenManagerInterface $jwtManager, JwtTokenManager $jwtToken, FilesystemAdapter $cache, TokenStorageInterface  $tokenStorage, MailerInterface $mailer)
    {
    ...
    public function exportUsersPdf(): Response
    {
        ...
        $email = (new TemplatedEmail())
            ...
            ->htmlTemplate('email/your_template.html.twig');
        $attachment = new $attachment(file_get_contents('pdf.html.twig'), 'document.pdf', 'application/pdf');
