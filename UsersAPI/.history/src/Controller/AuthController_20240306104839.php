...
class AuthController extends AbstractController
{
    ...
    public function __construct(EntityManagerInterface $entityManger, UserPasswordHasherInterface $passwordEncoder, JWTTokenManagerInterface $jwtManager, JwtTokenManager $jwtTokenManager)
    {
    ...
    public function login(Request $request): Response
    {
        ...
        $this->jwtTokenManager->saveTokenToCache()
