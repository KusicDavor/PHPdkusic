...
class AuthController extends AbstractController
{
    ...
    public function __construct(EntityManagerInterface $entityManger, UserPasswordHasherInterface $passwordEncoder, JWTTokenManagerInterface $jwtManager, AdapterInterface $cache)
    {
    ...
    public function logout(): JsonResponse
    {
        ...
        if (!$cacheItem->isHit()) {
            // Cache miss - handle the case where the data is not in cache
            return new JsonResponse(['message' => 'There has been an issue logging out.'], JsonResponse::HTTP_OK);
        }
        // Handle logout logic
        // Example response
