...
class AuthController extends AbstractController
{
    ...
    public function exportUsersCsv(): Response
    {
        ...
        $userAttributes = array_keys((new User())->toArray());

// Attributes to exclude from the header
$excludeAttributes = ['id', 'password', 'apiKey'];

// Remove excluded attributes from the list
$header = array_diff($userAttributes, $excludeAttributes);
        ...
        $email = (new TemplatedEmail())
            ...
            ->attach($response, 'users.csv', 'application/pdf');
