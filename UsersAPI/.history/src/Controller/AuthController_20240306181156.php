...
class AuthController extends AbstractController
{
    ...
    public function exportUsersCsv(Request $request): Response
    {
        ...
        foreach ($users as &$user) {
            // Check if 'contractStartDate' key exists
            if (isset($user['contractStartDate']) && $user['contractStartDate'] instanceof \DateTime) {
                // Convert DateTime objects to strings
                $user['contractStartDate'] = $user['contractStartDate']->format('Y-m-d H:i:s');
            }

            // Check if 'contractEndDate' key exists
            if (isset($user['contractEndDate']) && $user['contractEndDate'] instanceof \DateTime) {
                // Convert DateTime objects to strings
