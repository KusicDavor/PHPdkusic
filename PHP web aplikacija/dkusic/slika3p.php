...
<?php
	...
	if(isset($_GET['url'])){
		$id=$_GET['url'];
		$sql="SELECT slika.naziv,slika.url,slika.opis,datum_vrijeme_slikanja,ime,slika.korisnik_id,korisnik.prezime,planina.planina_id,planina.naziv
	...
	if(isset($_POST['reset']))header("Location:slika3p.php");
?>

<form method="POST" action="<?php if(isset($_GET['slika']))echo "slika3p.php?korisnik=$id";else echo "slika3p.php";?>">
	<table>
		<tbody>
			<tr>
				<td colspan="2">
