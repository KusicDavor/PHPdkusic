<?php
	...
	if(isset($_POST['reset']))header("Location:slika_uredi.php");
?>

<form id="dodajslika" method="POST" action="<?php if(isset($_GET['slika']))echo "slikauredi.php?slika=$slika_id";else echo "slika_uredi.php";?>">
	<table>
		<tbody>
			<tr>
				<td colspan="2">
			...
			<tr>
				...
				<td>
					<input type="text" name="url" id="url" value="<?php if(!isset($_POST['url']))echo $url; else echo $_POST['url'];?>"
			...
			<tr>
				...
				<td>
					<input type="text" name="datum_vrijeme_slikanja" id="datum_vrijeme_slikanja" value="<?php if(!isset($_POST['datum_vrijeme_slikanja'])) echo $datum_vrijeme_slikanja=date("d.m.Y. H:i:s",strtotime($datum_vrijeme_slikanja)); else echo $_POST['datum_vrijeme_slikanja'];?>"
						size="120" required="required"/>
				</td>
			</tr>
			<tr>
